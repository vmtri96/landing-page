export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Leverage the power of artificial intelligence to automate and optimize processes.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Advanced security measures to protect your valuable data and assets.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
